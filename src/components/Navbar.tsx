...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-[60] bg-cream border-b border-dark-teal/20">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-2.5 group z-[60]">
              <div className="w-8 h-8 rounded-full bg-dark-teal flex items-center justify-center">
      ...
      <div
        className={`fixed inset-0 bg-cream z-50 pt-24 px-6 transition-all duration-500 ease-in-out ${
        ...
        <div className="container mx-auto h-full flex flex-col justify-between pb-12">
          <div className="flex flex-col gap-6 mt-8">
            {navItems.map((item, index) => (
              <div
                key={item.label}
                className={`border-b border-dark-teal/20 pb-4 transform transition-all duration-500 delay-[${
                  index * 100
              ...
              >
                ...
                >
                  <span className="text-2xl md:text-3xl font-light uppercase tracking-[0.2em] text-foreground group-hover:text-dark-teal transition-colors">
                    {item.label}
                  </span>
                  <ChevronRight className="w-6 h-6 text-foreground/40 group-hover:text-dark-teal transition-colors" />
                </Link>
              </div>
            ))}
          </div>
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pt-8 border-t border-dark-teal/20">
