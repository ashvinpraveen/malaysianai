...
const communityPartners = [
  {
    ...
    summary:
      "A collaborative AI learning community centered on learning through building, with AI-native courses and certifications for different paths. It connects young professionals, AI evangelists, agencies, and solopreneurs who want to grow with a supportive builder network.",
  },
  {
    name: "Build with AI",
    ...
    summary:
      "A project showcase for the Build With AI Malaysia community, highlighting AI projects built by Malaysian builders across many categories. It helps people discover what locals are building and invites new members to join the community.",
  },
  {
    name: "AI Tinkerers",
    ...
    summary:
      "A global community of AI engineers and researchers building real systems and sharing unfinished work. Members meet locally and demo their work so builders can learn quickly and push practical AI forward.",
  },
  {
    name: "AI Hackerdorm",
    ...
    summary:
      "A student-first builder community that hosts regular sessions with project showcases, co-building time, and mentorship. It welcomes coders, designers, entrepreneurs, and curious makers who want to build and learn together.",
  },
  {
    name: "AI SEA",
    ...
    logo: "/aisea_logo.png",
    summary:
      "A Southeast Asia grassroots builder movement and network for people shipping AI, uniting local communities into one coalition. They run hackathons, co-build sessions, and sprints while sharing infrastructure so builders can collaborate across borders.",
  },
  {
    name: "Rakan Tutor",
    ...
    summary:
      "A nonprofit offering free, hybrid AI education for ASEAN youth through hands-on workshops and a digital learning platform. Its mission focuses on equipping secondary school students with skills and confidence for the AI-powered future.",
  },
];
