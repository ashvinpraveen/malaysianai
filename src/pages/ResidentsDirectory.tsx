...
const residents: Resident[] = [
  ...
  {
    name: "EasyBuzz",
    description: "Content engines that keep brand teams in motion.",
    focus: "Marketing",
    location: "Cyberjaya",
    cohort: "Cohort 03",
    status: "Active",
  ...
  },
  {
    ...
    description: "Building quietly while validating their first enterprise pilots.",
    focus: "Climate & Energy",
    location: "Malaysia",
    cohort: "Cohort 03",
    status: "Stealth",
    tags: ["Optimization", "Energy", "Infrastructure"],
